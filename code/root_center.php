			...
			<tr valign="top">
				<td width="15%">
					<div align="center"
						...
						<p align="center">
							<a href="root_center.php?page=find_member_info_form.php"> 編輯學生/教師資料 </a><br>		<!-- menu.php 是一欄選單,無論那一個頁面都會看到的一欄,就像facebook 左手邊那一欄東西 -->
							<a href="root_center.php?page=member_info.php"> 修改個人資料 </a><br>
							<a href="root_center.php?page=member_join_form.php">新增帳號</a><br>
							<a href="root_center.php?page=new_class_list_form.php">導生名單</a><br>
							<a href="root_center.php?page=message_board.php">留言版</a><br>
